...
def prediction(main_config, server_config_, pred_rounds, seed, mtp=False):
    ...
    print(average_ret)
    pred_result_dir = root_dir.replace('fed_imp10', 'fed_imp10_pred')
...
if __name__ == '__main__':
    ...
    datasets = [
        # ('svm', 0.05, 0.05),
        # ('ijcnn_balanced', 0.01, 0.01),
        # ('adult', 0.01, 0.01),
        # ('default_credit', 0.05, 0.05),
        # ('bank_marketing_balanced', 0.05, 0.05),
        # ('pendigits', 0.01, 0.025) ,
        # ('susy', 0.01, 0.01),
        # ('sensor', 0.01, 0.01),
    ...
    servers = ['central_lr_pytorch_pred', 'central_mlp_pytorch_pred']
    methods = ['local', 'fedavg-s', 'fedmechw', 'fedmechclw']
    ...
    for dataset, ss1, ss2 in datasets:
        for server in servers:
            ...
            for method in methods:
                ...
                main_config['data'] = 'fed_imp10/0716/{}'.format(dataset)
