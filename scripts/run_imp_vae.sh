...
echo "Executing command: python main_experiment_vae.py config_vars/imp_extention2=${config_name}.yaml"
python main_experiment_vae.py config_vars/imp_extention2="${config_name}".yaml
