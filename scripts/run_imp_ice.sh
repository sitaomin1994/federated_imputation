...
echo "Executing command: python main_experiment_amarel.py config_vars/imp_extention2=${config_name}.yaml"
python main_experiment_amarel.py config_vars/imp_extention2="${config_name}".yaml
