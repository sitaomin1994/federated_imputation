...
# Sensor
########################################################################################################################
def process_sensor(normalize=True, verbose=False, threshold=0.2):
	if threshold is None:
		threshold = 0.2
...
def process_adult(normalize=True, verbose=False, threshold=None, sample=False):
...
def process_codrna(normalize=True, verbose=False, threshold=None):
...
def process_bank_market(normalize=True, verbose=False, threshold=None, sample=False):
	if threshold is None:
		threshold = 0.1
...
def process_ijcnn(normalize=True, verbose=False, threshold=None, sample=False):
	if threshold is None:
		threshold = 0.1
...
def process_svm(normalize=True, verbose=False, threshold=None):
	if threshold is None:
		threshold = 0.1
...
def process_statlog(normalize=True, verbose=False, threshold=None):
	if threshold is None:
		threshold = 0.1
...
def process_susy(normalize=True, verbose=False, threshold=0.15):
	if threshold is None:
		threshold = 0.15
...
def load_data(dataset_name, normalize=True, verbose=False, threshold=None):
	...
	if dataset_name == 'iris':
		...
		return process_codrna(normalize, verbose, threshold)
