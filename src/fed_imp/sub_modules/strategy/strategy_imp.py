...
class StrategyImputation:
	...
	def aggregate(
		...
		elif self.strategy == 'fedwavg_proj':
			agg_weight = fedwavg3(weights, project_matrix, missing_infos)
		# ==============================================================================================================
		# Missing Mechanism Average Algorithm
		# ==============================================================================================================
		elif self.strategy == 'fedmechclw':
			...
			agg_weight = fedmechclwcl(weights, missing_infos, ms_coefs)
		elif self.strategy == 'fedmechcl2':
			agg_weight = fedmechcl2(weights, missing_infos, ms_coefs, top_k_idx_clients)
		elif self.strategy == 'fedmechcl4':
			agg_weight = fedmechcl4(weights, missing_infos, ms_coefs)
		else:
			raise ValueError(
