...
PARAMS = {
    "codrna":
        {  # s1 - lr
            ...
            (5, "sample-unevenl1-1000", "mnar_lr@sp=extremel1"): (0.05, 0.5, 2),
            (7, "sample-unevenl1-1000", "mnar_lr@sp=extremel1"): (0.05, 0.5, 2),
            (9, "sample-unevenl1-1000", "mnar_lr@sp=extremel1"): (0.05, 0.5, 2),
            (11, "sample-unevenl1-1000", "mnar_lr@sp=extremel1"): (0.05, 0.8, 2),
            # s2 - even
