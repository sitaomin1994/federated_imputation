...
if __name__ == '__main__':
    ...
    seed = 21
    mtp = True
    datasets = ['fed_imp_ext_pc2/0216/codon', 'fed_imp_ext_pc2/0216/codon']
    train_params = [
    ...
    for d, train_param in zip(datasets, train_params):
        ...
        for sample_size in sample_sizes:
            n_clients = [10]
            scenario = ["random2@mrl=0.3_mrr=0.7_mm=mnarlrsigst/allk0.25_sphere"]  # "random2@mrl=0.2_mrr=0.8_mm=mnarlrq"]
